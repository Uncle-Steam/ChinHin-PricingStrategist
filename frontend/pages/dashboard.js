  ...
  factors: [
    {
      ...
      impact: 'positive',
      detail:
        'Dealer has placed 12 orders in the last 6 months — qualifies for loyalty tier pricing.',
    },
    {
      label: 'Stock Aging',
      impact: 'positive',
      detail:
        'Current stock age is 47 days. A 3–5% discount is recommended to accelerate inventory turnover.',
    },
    {
      label: 'Market Demand',
      impact: 'neutral',
      detail:
        'Demand index at 72/100. Moderate demand allows for slight margin protection without losing the deal.',
    },
    {
      label: 'Competitor Pricing',
      impact: 'warning',
      detail:
        'Competitor last quoted RM 980. Undercutting by RM 30 gives a competitive edge while preserving margin.',
    },
  ],
  summary:
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Fiamma AI Pricing Strategist Dashboard"
        />
        ...
        <main className={styles.main}>
          ...
          <div className={styles.welcomeBar}>
            ...
            <div className={styles.channelFilter}>
              {['All', 'Traditional', 'Corporate', 'E-Commerce', 'Project'].map(
                (ch) => (
                  <button
                    key={ch}
                    className={`${styles.filterBtn} ${
                      selectedChannel === ch ? styles.filterBtnActive : ''
                    }`}
            ...
            <div className={styles.panelHeader}>
              <div>
                <h2 className={styles.panelTitle}>
                  Multifactor Pricing Analysis
                </h2>
                <p className={styles.panelSub}>
                  Price range per sales channel — Min / Optimal / Max /
                  Competitor
                </p>
              </div>
            ...
            <ResponsiveContainer width="100%" height={300}>
              ...
              >
                ...
                <ReferenceLine
                  ...
                  strokeDasharray="4 4"
                  label={{ value: 'Rec. Price', fill: '#c0392b', fontSize: 10 }}
                />
              </ComposedChart>
            </ResponsiveContainer>
          </section>
          ...
          <section className={styles.panel}>
            <div className={styles.panelHeader}>
              <div>
                ...
                <p className={styles.panelSub}>
                  Adjust parameters to shape the AI&#39;s pricing logic
                </p>
              </div>
            </div>
          ...
          <section className={styles.panel}>
            <div className={styles.panelHeader}>
              <div>
                ...
                <p className={styles.panelSub}>
                  Why the AI recommends this price point
                </p>
              </div>
              <div className={styles.recommendBadge}>
                ...
                <span className={styles.confidencePill}>
                  {mockReasoning.confidence}% confidence
                </span>
              </div>
            </div>
            ...
            {chatMessages.map((msg, i) => (
              <div
                ...
                className={`${styles.chatMsg} ${
                  msg.from === 'user' ? styles.chatMsgUser : styles.chatMsgAi
                }`}
              >
                {msg.text}
              </div>
